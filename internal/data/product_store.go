...
func (d *ProductStore) InsertProduct(product model.Product) error {
...
func (d *ProductStore) GetProducts() ([]model.Products, error) {
...
func (d *ProductStore) GetProductByID(id uuid.UUID) (model.Products, error) {
	var product model.Products
...
func (d *ProductStore) UpdateProductByID(id uuid.UUID, product model.Products) error {
